 ...
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |LCtrl | LGUI | LAlt | Space| Sym  |  |Enter | Nav  | Fkeys| Hub  | \  | |
 *                        `----------------------------------'  `----------------------------------'
 * ,-----------------------------------.                                              ,-----------------------------------.
 ...
 */
    [_QWERTY] = LAYOUT_split_3x6_5_hlc(
     ...
     KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , KC_LBRC, _______,    _______, KC_RBRC, KC_N,   KC_M ,  KC_COMM, KC_DOT ,KC_SLSH, KC_ENT,
                                KC_LCTL, KC_LGUI, KC_LALT, KC_SPC , NAV    ,    KC_ENT , NAV    , FKEYS,  HUB  , KC_BSLS,
 ...
 */
    [_SYM] = LAYOUT_split_3x6_5_hlc(
     ...
     _______, _______,  _______, _______, _______,                                                       _______, _______, _______, KC_UNDS, KC_EQL
    ),
